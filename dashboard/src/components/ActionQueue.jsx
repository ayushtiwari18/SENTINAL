  ...
  const modal = confirm ? createPortal(
    <div style={styles.modalOverlay}>
      <div style={styles.modal}>
        ...
        {modalError && (
          <div style={styles.modalError}>⚠️ {modalError}</div>
        )}

        <div style={styles.modalActions}>
          <button className="btn btn-ghost" onClick={handleCancel} disabled={processing}>
            Cancel
          </button>
          <button
              ...
              <div style={styles.cardBody}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={styles.badgeRow}>
                    ...
                    {item.attackType && <span className="attack-tag">{item.attackType}</span>}
